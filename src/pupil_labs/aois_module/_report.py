...
from reportlab.platypus import SimpleDocTemplate, Image, Paragraph, PageBreak, Spacer, Table, TableStyle, Frame, PageTemplate
...
def generate_report(self):
    ...
    header_content= Table([[logo, title]], colWidths=[2*cm, 14*cm], rowHeights=[2*cm])
